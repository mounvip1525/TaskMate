...
env=environ.Env(SECRET_KEY=str,) #specifying the variable
environ.Env.read_env(os.path.join(BASE_DIR,'.env')) #specifying the location of the .env file
...
CRISPY_TEMPLATE_PACK='bootstrap4' #by-default cripsy_forms supoort only bootsrap2
...
django_heroku.settings(locals()) #heroku support

STATIC_ROOT=os.path.join(BASE_DIR,'staticfiles') #support for adding the static files into heroku